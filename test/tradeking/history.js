...
tradeking_consumer.get(configuration.apiUrl + '/accounts/' + configuration.accountId + '/history.json?transactions=trade', configuration.accessToken, configuration.accessSecret, function(error, data, response) {
    // Parse the JSON data
