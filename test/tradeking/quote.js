...
tradeking_consumer.get(configuration.apiUrl + '/market/ext/quotes.json?symbols=AMZN', configuration.accessToken, configuration.accessSecret, function(error, data, response) {
    // Parse the JSON data
