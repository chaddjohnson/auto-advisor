...
tradeking_consumer.get(configuration.api_url + '/market/ext/quotes.json?symbols=AMZN', configuration.access_token, configuration.access_secret, function(error, data, response) {
    // Parse the JSON data
    quote_data = JSON.parse(data);

    // Display the response
    console.log(quote_data.response.quotes.quote.last);
});
