...
tradeking_consumer.get(configuration.apiUrl + '/accounts/' + configuration.accountId + '.json', configuration.accessToken, configuration.accessSecret, function(error, data, response) {
    // Parse the JSON data
